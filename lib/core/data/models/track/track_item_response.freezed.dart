...
TrackItemResponse _$TrackItemResponseFromJson(Map<String, dynamic> json) {
  return _TrackItemResponse.fromJson(json);
}

/// @nodoc
mixin _$TrackItemResponse {
  ...
  @JsonKey(ignore: true)
  $TrackItemResponseCopyWith<TrackItemResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TrackItemResponseCopyWith<$Res> {
  factory $TrackItemResponseCopyWith(
          TrackItemResponse value, $Res Function(TrackItemResponse) then) =
      _$TrackItemResponseCopyWithImpl<$Res, TrackItemResponse>;
  @useResult
  $Res call(
      {AlbumEntity album,
...
/// @nodoc
class _$TrackItemResponseCopyWithImpl<$Res, $Val extends TrackItemResponse>
    implements $TrackItemResponseCopyWith<$Res> {
  _$TrackItemResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_TrackItemResponseCopyWith<$Res>
    implements $TrackItemResponseCopyWith<$Res> {
  factory _$$_TrackItemResponseCopyWith(_$_TrackItemResponse value,
          $Res Function(_$_TrackItemResponse) then) =
      __$$_TrackItemResponseCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {AlbumEntity album,
...
/// @nodoc
class __$$_TrackItemResponseCopyWithImpl<$Res>
    extends _$TrackItemResponseCopyWithImpl<$Res, _$_TrackItemResponse>
    implements _$$_TrackItemResponseCopyWith<$Res> {
  __$$_TrackItemResponseCopyWithImpl(
      _$_TrackItemResponse _value, $Res Function(_$_TrackItemResponse) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_TrackItemResponse(
      album: null == album
          ? _value.album
          : album // ignore: cast_nullable_to_non_nullable
              as AlbumEntity,
...
/// @nodoc
@JsonSerializable()
class _$_TrackItemResponse implements _TrackItemResponse {
  ...
  factory _$_TrackItemResponse.fromJson(Map<String, dynamic> json) =>
      _$$_TrackItemResponseFromJson(json);
  ...
  @override
  String toString() {
    return 'TrackItemResponse(album: $album, artists: $artists, duration_ms: $duration_ms, href: $href, id: $id, name: $name, popularity: $popularity, track_number: $track_number, uri: $uri, preview_url: $preview_url, is_playable: $is_playable)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_TrackItemResponseCopyWith<_$_TrackItemResponse> get copyWith =>
      __$$_TrackItemResponseCopyWithImpl<_$_TrackItemResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_TrackItemResponseToJson(
      this,
    );
  }
}

abstract class _TrackItemResponse implements TrackItemResponse {
  factory _TrackItemResponse(
      ...
      final String preview_url,
      final bool is_playable}) = _$_TrackItemResponse;

  factory _TrackItemResponse.fromJson(Map<String, dynamic> json) =
      _$_TrackItemResponse.fromJson;
